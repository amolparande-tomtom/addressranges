...
def fetch_data_and_create_dataframe(SQLQuery):
...
if __name__ == '__main__':
    ...
    for i, arow in ovAdminAreaOrder8Area(schemaname).iterrows():
        ...
        connection_pool = psycopg2.pool.ThreadedConnectionPool(min_conn, max_conn, **db_params)

        # Call the function to get the DataFrame
        postgresSQl = fetch_data_and_create_dataframe(addresRanges)
        ...
        # postgresSQl = pd.read_sql(addresRanges, pgConnection)
